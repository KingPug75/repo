...
def write_batch_id_files(tv_ids, movie_ids, misc_ids):
    if len(tv_ids) > 0:
        shows_import_file_path = "special://home/userdata/addon_data/plugin.video.chappaai/shows_to_add.txt"
    ...
    if len(movie_ids) > 0:
        movies_import_file_path = "special://home/userdata/addon_data/plugin.video.chappaai/movies_to_add.txt"
    ...
    if len(misc_ids) > 0:
        misc_import_file_path = "special://home/userdata/addon_data/plugin.video.chappaai/misc_to_add.txt"
